    ...
    return (
        ...
        <div className="w-[90%]">
            ...
            <h4 className="py-10 text-4xl flex flex-col gap-2 font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#000000] to-[#28425f]">
                Our Services
                <hr className="bg-gradient-to-r from-[#28425f] to-[#76766b] h-1 rounded-full w-16 self-center" />
            </h4>
            </div>
    ...
    //                 </div>
        ...
        <div className={`${styles.card_box}`}>
            <span></span>
                ...
                <button className="flex items-center justify-center bg-[#000000] hover:bg-[#000000] text-white font-bold p-3 px-6 rounded-xl  transition-colors duration-300 ease-in-out">
