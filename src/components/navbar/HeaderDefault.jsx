...
function HeaderDefault() {
    ...
    return (
        <div className="flex z-[999] absolute w-full justify-center items-center">
            <div className="flex-col skeleton-navbar bg-black text-white dark:bg-opacity-30 bg-opacity-30 dark:bg-[#06273A] md:flex-row flex justify-between px-2 md:px-10 rounded-md w-[90%] items-center backdrop-filter backdrop-blur-md py-1 mt-4">
