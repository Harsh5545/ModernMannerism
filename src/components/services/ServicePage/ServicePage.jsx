...
const ServicePage = ({ params }) => {
  ...
  return (
    <div className="flex items-center pb-4 md:pb-10 justify-center w-full flex-col  bg-gray-100">
      {/* Hero Section */}
      <div
        className=" h-[50vh] lg:h-[30vh] bg-[#8f7971]  w-full pb-5 bg-cover bg-center flex items-end justify-center"
        ...
        <div className="mt-6 p-6 ">
          ...
          <ul className="mt-6 grid grid-cols-1 md:grid-cols-1 gap-4">
            ...
            {programOptions.map((option, index) => (
              ...
              > 
               <div className="flex items-cente gap-4 md:px-24 items-center"> <span className="w-2 h-2  rounded-full bg-gray-700"></span>                
{option}</div>
              </li>
            ))}
          </ul>
...
<section className="mt-14  py-4 bg-white rounded-lg shadow-md text-center">
  ...
  <ul className="mt-6 items-center flex flex-wrap md:px-24 px-4 justify-start gap-1">
    {highlights.map((highlight, index) => (
      ...
      >
     <div className="flex gap-4 items-cente">   <CheckCircleOutlineIcon className="text-gray-700" />
        {highlight}</div>
      </li>
    ))}
  </ul>
